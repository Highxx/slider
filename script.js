...
const entities = [
  {
    ...
    line: document.querySelector('.decorate-1'),
  ...
  },
  {
    ...
    line: document.querySelector('.decorate-2'),
    city: 'Sochi Thieves',
    area: '105 m2',
    time: '4 months'
  },
  {
    ...
    line: document.querySelector('.decorate-3'),
...
const makeActive = (index) => {
  ...
  entities[index].line.classList.add('color-hypertext');
}

const makeInactive = (index) => {
  entities[index].dot.style.opacity = 0.3;
  entities[index].line.classList.remove('color-hypertext');
}
